...
namespace SalesCRMApp.Controllers
{
    ...
    public class LeadController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Password,Status")] SalesLeadEntity salesLeadEntity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Password,Status")] SalesLeadEntity salesLeadEntity)
        {
